...
import sis.apartamentos.com.br.api.v1.dto.apartamento.ApartamentoPostDTO;
import sis.apartamentos.com.br.api.v1.dto.apartamento.ApartamentoPutDTO;
import sis.apartamentos.com.br.api.v1.dto.apartamento.ApartamentoResponseDTO;
...
import sis.apartamentos.com.br.api.v1.icontroller.ApartamentoControllerOpenApi;
import sis.apartamentos.com.br.domain.repository.ApartamentoRepository;
import sis.apartamentos.com.br.domain.service.ApartamentoService;
...
public class ApartamentoController implements Serializable, ApartamentoControllerOpenApi {
	...
	@GetMapping
	@Override
	@PreAuthorize("hasAuthority('ROLE_APARTAMENTO') and hasAuthority('SCOPE_read')" )
	...
	@PostMapping
	@Override
	@PreAuthorize("hasAuthority('ROLE_APARTAMENTO') and hasAuthority('SCOPE_write')" )
